...
export default function Home() {
  ...
  console.log("Testing ENV: ",import.meta.env.VITE_TEST_ENV);
    ...
    <div>
        ...
        <div className="featured-listings py-10">
          ...
          <div className="flex flex-col justify-center items-center">
            ...
            <button className="bg-green-500 text-white active:bg-emerald-600 font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
            type="button" onClick={navigateToListings}>
              View More
            </button>
          </div>
        </div>

...
const Cardtest = ({ property}) => {
  ...
  return (
    <>
      <div className="max-w-6xl mx-auto cursor-pointer" onClick={cardClick}>
        <div className="flex items-center justify-center">
          <div className="max-w-sm w-full sm:w-full lg:w-full py-1 md:py-6 px-3">
            <div className="bg-white shadow-xl rounded-lg overflow-hidden">
            <div className="bg-cover bg-center h-56 relative">
                <div className="absolute inset-0 z-10 flex justify-end p-4">
                  <a href="#waray"> {/* Add Watchlist */}
              ...
              <div className="p-4">
                <p className="uppercase tracking-wide text-sm font-bold text-gray-700">{property.property_type}</p>
                <p className="text-3xl text-gray-900"><span className="text-xl uppercase">
                    &#8369;
                    </span>{property.price}/m</p>
              ...
              <div className="flex p-4 border-t border-gray-300 text-gray-700">
                <div className="flex-1 inline-flex items-center">
                  ...
                  <p><span className="text-gray-900 font-bold">{property.num_bedrooms}</span> Bedrooms</p>
                </div>
                <div className="flex-1 inline-flex items-center">
                  <svg className="h-6 w-6 text-gray-600 fill-current mr-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                  ...
                  <p><span className="text-gray-900 font-bold">{property.num_rooms}</span> Bathrooms</p>
                </div>
              </div>
              <div className="px-4 pt-3 pb-4 border-t border-gray-300 bg-gray-100">
                ...
                <div className="flex items-center pt-2">
                    ...
                    <div>
                      <p className="font-bold text-gray-900">{property.owner_full_name}</p>
                      <p className="text-sm text-gray-700">{property.owner_email}</p>
                    </div>
                  </div>
              </div>
            </div>

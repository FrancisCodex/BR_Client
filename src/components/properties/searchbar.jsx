  ...
  return (
    <div>
      ...
      <div className="w-full md:w-1/6 px-3 mb-6 md:mb-0">
                <input className="appearance-none block w-full bg-grey-lighter text-grey-darker border border-green-400 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-grey" id="grid-city" type="text" placeholder="Butuan City" />
              </div>
              <div className="w-full md:w-1/6 px-3 mb-6 md:mb-0">

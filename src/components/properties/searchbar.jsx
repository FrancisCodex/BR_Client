                    ...
                    {isDropdownMenuOpen2 && (
                                ...
                                <input type="text" />
                                  <ul className="py-1 text-sm text-gray-700">
                                    <div className='px-3'>
                                        <input id="default-checkbox" type="checkbox" value="Wifi" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
                                        <label htmlFor="default-checkbox" className="label-text ms-2 text-sm font-normal text-gray-900 dark:text-gray-300">Wifi</label>
                                    </div>
                                    <div className='px-3'>
                                        <input id="default-checkbox" type="checkbox" value="parking" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
                                    ...
                                    <div className='px-3'>
                                        <input id="default-checkbox" type="checkbox" value="security" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
                                    ...
                                    <div className='px-3'>
                                        <input id="default-checkbox" type="checkbox" value="aircondition" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
                                    ...
                                    <div className='px-3'>
                                        <input id="default-checkbox" type="checkbox" value="washer" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
                                    ...
                                    <div className='px-3'>
                                        <input id="default-checkbox" type="checkbox" value="dryer" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
                                    ...
                                    <div className='px-3'>
                                        <input id="default-checkbox" type="checkbox" value="furnished" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
                                    ...
                                    <div className='px-3'>
                                        <input id="default-checkbox" type="checkbox" value="kitchen" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
                                    ...
                                    <div className='px-3'>
                                        <input id="default-checkbox" type="checkbox" value="elavator" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
                                    ...
                                    <div className='px-3'>
                                        <input id="default-checkbox" type="checkbox" value="furnished" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
                                        <label htmlFor="default-checkbox" className="label-text ms-2 text-sm font-normal text-gray-900 dark:text-gray-300">Furnished</label>
                                    </div>
                                  </ul>
                              </div>
                      )}

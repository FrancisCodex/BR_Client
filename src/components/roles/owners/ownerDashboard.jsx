...
const OwnerDashboard = () => {
  ...
  useEffect(() => {
    const fetchProperties = async () => {
      try {
        ...
        const response = await instance.get('/api/property/view/all', {
          headers: {
  ...
  console.log("What is the properties: ", properties.length);
  return (
    <div>
      <Navigation/>
      <div>
      ...
      <main className="flex-1 bg-gray-200">
            ...
            <div className="flex flex-wrap -mx-6">
              ...
              <div className="w-full px-6 mt-6 sm:w-1/2 xl:w-1/2 sm:mt-0">
                <div className="flex items-center px-5 py-6 bg-white rounded-md shadow-sm">
                  ...
                  <div className="mx-5">
                    <h4 className="text-2xl font-semibold text-gray-700">{properties.length}</h4>
        ...
        <div className="container text-3xl">
          ...
          {properties.map(property => (
            <Propertlist key={property.property_id} property={property} />
          ))}
        </div>

...
import logotext from '../assets/BoardRoom_text.svg'
        ...
        <div className="flex items-end w-full  bg-white pt-14">
            <footer className="w-full text-gray-700 bg-gray-100 body-font">
                ...
                <div className="flex-shrink-0 w-64 mx-auto text-center md:mx-0 md:text-left">
                    ...
                    {/* <div className=" h-5 text-gray-900 fill-current">
                        <img src={logotext} alt="BoardRoom Text Logo" width={200} />
                    </div> */}
                    </a>
                    <p className="mt-2 text-sm text-gray-500">Finding homes just became easy!</p>
                    <div className="mt-4">
                ...
                <div className="flex flex-wrap flex-grow mt-10 -mb-10 text-center md:pl-20 md:mt-0 md:text-left">
                    ...
                    <nav className="mb-10 list-none">
                        ...
                        <li className="mt-3">
                        <a className="text-gray-500 cursor-pointer hover:text-gray-900">Documentation</a>
                        </li>
                        <li className="mt-3">
                    ...
                    <nav className="mb-10 list-none">
                        ...
                        <li className="mt-3">
                        <a className="text-gray-500 cursor-pointer hover:text-gray-900">Email us</a>
                        </li>
                        <li className="mt-3">
                        <a className="text-gray-500 cursor-pointer hover:text-gray-900">+6391171192001</a>
                        </li>
                    </nav>
                    </div>
                </div>
                ...
                <div className="container px-5 py-4 mx-auto">
                    <p className="text-sm text-gray-700 capitalize xl:text-center">©FrancisCodex</p>
